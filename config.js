...
module.exports = {
     ...
     */
    botname: process.env.BotName || "zak bot",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 zak ff ",
     ...
     */
    ownername: process.env.Owner_Name || "zak",
    ownernumber: process.env.Owner_Number || "18768375254",
    ...
    sessionId: process.env.SESSION_ID || "XYUmjENfAdjRhm_A_N_Y_A_V_2_csmNT0",
